...
import { crearCasoController, listarCasosController, resolverCasoController } from './devoluciones.controller.js';
import { decisionCasoSchema, devolucionSchema } from './devoluciones.schemas.js';
const router = Router();
...
router.put('/:id/decision', validarSolicitud(decisionCasoSchema), manejarAsync(resolverCasoController));
